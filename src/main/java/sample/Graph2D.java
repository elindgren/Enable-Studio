...
public class Graph2D {
    ...
    public Graph2D(LineChart<Number,Number> lineChart, XYChart.Series<Number,Number> series, ValueAxis x, ValueAxis y, String str, ObservableList<Integer> progressList){
