...
public class Controller implements Initializable {
    ...
    public void initialize(URL fxmlFileLocation, ResourceBundle resources) {
        ...
        System.out.println("Retrieving progressList");
    ...
    private void setupSensor(){
        ...
        System.out.println("Sensor setup done");
        //*****************************************************************************************************//
    }
    ...
    private void setupButtons(){
        ...
        Node iconRefresh = GlyphsDude.createIcon(MaterialDesignIcon.USB,iconSize);
        iconRefresh.getStyleClass().add("material-icon-USB");
        /*iconRefresh.setStyle("-fx-text-fill: #00c853");*/
        ...
        */
        ...
        findMax.setGraphic(new ImageView(new Image("file:classes/images/iconsBlack/chartLineSmallBlack.png")));
        findMax.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                StandardView std = (StandardView)viewList.get(0);
                if(std.getChartStatus() ){
                    std.findMax();
        ...
        findMin.setGraphic(new ImageView(new Image("file:classes/images/iconsBlack/chartLineSmallBlack.png")));
    ...
    private void prepareSlideMenuAnimationHamburger(){
        ...
        navList.setCache(true);
        navList.setCacheHint(CacheHint.SPEED);
        menuHamburger.addEventHandler(MouseEvent.MOUSE_PRESSED, (e) -> {
            if(navList.getTranslateX()!=0){
                navList.setCacheHint(CacheHint.SPEED);
                openNav.play();
                navList.setCacheHint(CacheHint.QUALITY);
            }
            else{
                navList.setCacheHint(CacheHint.SPEED);
    ...
    public void prepareOverlayMenuAnimation(){
        ...
        */
        ...
        TranslateTransition openOverlay = new TranslateTransition(new Duration(500), overlayPane);
        openOverlay.setInterpolator(Interpolator.EASE_BOTH);
        openOverlay.setToY(0);
        TranslateTransition closeOverlay = new TranslateTransition(new Duration(500), overlayPane);
        ...
        overlayButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if(overlayPane.getTranslateY()!=0){
                    ...
                    openOverlay.play();
                    overlayPane.setCacheHint(CacheHint.QUALITY);
                    //openOverlayRot.play();
